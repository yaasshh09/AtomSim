...
- Commit after every task. Commit messages carry no AI attribution.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-07-27-phase21-hartree-fock-design.md`
- Modify: `README.md` if it lists supported atoms
...
`numerics/slater.py` to the `CLAUDE.md` architecture section, in the style of the
existing entries.

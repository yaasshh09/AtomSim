...
**Spec:** `docs/specs/2026-08-04-phase29-density-comparison-design.md`
...
- Commit per logical change, straight to `main`.
...
- Modify: `web/src/components/RadialView.tsx` (the GSZ caption at the end of the
  density block)
- Modify: `README.md`
- Modify: `docs/plans/2026-08-04-phase29-density-comparison.md` (this
  file, appending the closeout section)
- Modify: `docs/specs/2026-08-04-phase29-density-comparison-design.md`

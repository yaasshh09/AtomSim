...
**Design spec:** `docs/specs/2026-08-03-phase26-hartree-fock-3d-design.md`
...
- Commit after every task. The tree is left committed and push-ready. Commit straight to `main`.
...
- Modify: `docs/specs/2026-08-03-phase26-hartree-fock-3d-design.md` (status line and a short "what building it changed" section)

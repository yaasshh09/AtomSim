...
export function ShowPhysics() {
  ...
  // The maths under it does not exist until someone asks for it. This latches
  // on first open rather than tracking `open`, so the chunk is not torn down
  // and refetched every time the panel collapses.
